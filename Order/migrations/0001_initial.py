    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='Account.Group')),
                ...
                ('work_type', models.ManyToManyField(to='Order.WorkType')),
                ('workers', models.ManyToManyField(to='Account.ExtUser')),
            ],
        ),
    ]
